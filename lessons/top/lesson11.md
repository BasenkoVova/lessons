...
### Все материалы проекта (в том числе и будущие обновления) останутся доступны без органичения по времени в [Google Drive](https://drive.google.com/drive/folders/0B9Ye2auQ_NsFflp6ZHBLSFI2OGVEZ2NQU0pzZkx4SnFmOWlzX0lzcDFjSi1SRk5OdzBYYkU)
...
### ![video](https://cloud.githubusercontent.com/assets/13649199/13672715/06dbc6ce-e6e7-11e5-81a9-04fbddb9e488.png) 1. <a href="https://drive.google.com/open?id=18ZMW65OYVOsfPhngqsvr73VmHyrmdgLM">HW10</a>
...
###  ![video](https://cloud.githubusercontent.com/assets/13649199/13672715/06dbc6ce-e6e7-11e5-81a9-04fbddb9e488.png) 2. <a href="https://drive.google.com/open?id=1NKFwVcEzgoDSQe39ewutxXV2kty_6DFz">HW10 Optional: change locale</a>
...
###  ![video](https://cloud.githubusercontent.com/assets/13649199/13672715/06dbc6ce-e6e7-11e5-81a9-04fbddb9e488.png)  <a href="https://drive.google.com/open?id=1oYcJCgLiW1ks3uMf1YlYOEp82joBKjv0">3. Деплой приложения в Heroku.</a>
...
###  ![video](https://cloud.githubusercontent.com/assets/13649199/13672715/06dbc6ce-e6e7-11e5-81a9-04fbddb9e488.png)  <a href="https://drive.google.com/open?id=1xm7MXIpm9lpBGYMuYq2g4HTmjbWtotW1">4. Собеседование. Разработка ПО</a>
...
###  ![video](https://cloud.githubusercontent.com/assets/13649199/13672715/06dbc6ce-e6e7-11e5-81a9-04fbddb9e488.png)  <a href="https://drive.google.com/open?id=1f9GealiCAFvVCaQood1g6WjOzzpMkwta">5. Разбор типовых собеседований (необработанный вебинар)</a>
...
- **Заполнить в [своем профиле Java Online Projects](http://javaops.ru/auth/profileER) ссылку на резюме и информацию по поиску работы (если конечно актуально): резюме, флаги рассматриваю работу, готов к релокации и информация для HR.**
   - Рассылку обновления базы соискателей по HR буду рассылать по **27.12**, постарайтесь успеть
- **Получить первое открытое занятие МНОГОПОТОЧНОСТЬ и пройти эту важную тему в [проекте Masterjava](http://javaops.ru/view/masterjava)**
   ...
   - **По 31.12 цена для участника снижена до 5950 руб.**
- **Когда будет готов выпускной проект, [заполни форму проверки](https://docs.google.com/forms/d/1G8cSGBfXIy9bNECo6L-tkxWQYWeVhfzR7te4b-Jwn-Q) (возможно доплатить за ревью отдельно из JavaOPs профиля, как за тестовое собеседование: 1950р)**
  - Для участников с проверкой выпускной проект принимаю на ревью до **16.01.2020** (участникам [Masterjava](http://javaops.ru/view/masterjava) до 16.04.2020). Проверять буду со следующей недели, сначала Татьяна/Катерина, затем я. ОДИН раз.
- **Стажировка AT Consulting планируется в конце января 2020, будет рассылка. Для участия в ней необходимо желание и возможность трудоустроится в компанию (Москва, Санкт-Петербург) и успешно сданный выпускной (проект запускается, запросы проходят, грубых ляпов нет). Перечитайте [Рекомендации](https://github.com/JavaWebinar/topjava/blob/doc/doc/graduation.md#-рекомендации) еще раз и очень внимательно!**
