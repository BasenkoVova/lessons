...
#### Apply 9_0_fix.patch
> Починил `SpringMain`, профили не требуются. 
...
### Добавил валидацию для `JdbcUserRepository` через Bean Validation API
...
#### Apply 9_11_jsp_form_login.patch
> Рефакторинг
